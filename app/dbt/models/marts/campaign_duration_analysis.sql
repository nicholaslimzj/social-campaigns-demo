...
/*
This model analyzes the relationship between campaign duration and performance metrics to:
1. Identify optimal campaign durations for different combinations of goals, segments, and channels
2. Analyze performance trends across different duration ranges
3. Provide specific duration recommendations based on statistical analysis
4. Calculate the ROI impact of optimal vs. suboptimal durations

The approach uses statistical analysis techniques that can be implemented in SQL
