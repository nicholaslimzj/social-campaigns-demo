...
/*
Model: segment_company_quarter_rankings
...
for the current quarter to identify which companies perform best for specific segments.
...
-- First, get metrics by segment and company for the current quarter
